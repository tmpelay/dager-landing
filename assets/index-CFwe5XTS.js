 ...
 */ (function (e) {
  ...
  function r(E) {
    ...
    if (j !== z) {
      E[0] = j;
      e: for (var W = 0, G = E.length, qt = G >>> 1; W < qt; ) {
        var vn = 2 * (W + 1) - 1,
          yl = E[vn],
          yn = vn + 1,
          bt = E[yn];
        if (0 > l(yl, j))
          yn < G && 0 > l(bt, yl)
            ? ((E[W] = bt), (E[yn] = j), (W = yn))
            : ((E[W] = yl), (E[vn] = j), (W = vn));
        else if (yn < G && 0 > l(bt, j)) (E[W] = bt), (E[yn] = j), (W = yn);
        else break e;
      }
    }
    return z;
  ...
  function y(E) {
    if (((S = !1), d(E), !k))
      if (t(s) !== null) (k = !0), hl(_);
      else {
        var z = t(c);
        z !== null && vl(y, z.startTime - E);
      }
  }
  function _(E, z) {
      ...
      return (
        ...
        j > W
          ? ((E.sortIndex = j),
            ...
            t(s) === null &&
              E === t(c) &&
              (S ? (f(P), (P = -1)) : (S = !0), vl(y, j - W)))
          : ((E.sortIndex = G), n(s, E), k || w || ((k = !0), hl(_))),
        E
      );
    }),
...
function Ho(e) {
  if ((e = Zt(e))) {
    if (typeof ri != "function") throw Error(g(280));
    var n = e.stateNode;
...
function Fc(e, n, t, r, l, i, o, u, s) {
  (xt = !1), (Lr = null), Mc.apply(Ic, arguments);
}
...
function qc(e, n, t, r, l) {
  switch (n) {
    ...
    case "pointerover":
      var i = l.pointerId;
      return Dt.set(i, ft(Dt.get(i) || null, e, n, t, r, l)), !0;
    case "gotpointercapture":
      return (
...
var vf = V({}, Gt, {
  ...
  kf = we(wf),
  Sf = V({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xf = we(Sf),
  _f = V({}, nl, {
    deltaX: function (e) {
      ...
      P &&
        (Os &&
          ...
          (Mn || P !== "onCompositionStart"
            ? P === "onCompositionEnd" && Mn && (N = Ds())
            : ((en = h),
              (qi = "value" in en ? en.value : en.textContent),
              (Mn = !0))),
        (C = Ir(c, P)),
        0 < C.length &&
          ((P = new Zo(P, e, null, t, h)),
          m.push({ event: P, listeners: C }),
          N ? (P.data = N) : ((N = Is(t)), N !== null && (P.data = N)))),
        (N = Nf ? Pf(e, t) : zf(e, t)) &&
...
function na(e) {
  ...
  function p(f, a, d, y) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (gt(d) || at(d)) return _ !== null ? null : h(f, a, d, y, null);
      dr(f, d);
    }
    return null;
  }
  function w(f, a, d, y, _) {
    ...
    if (typeof y == "object" && y !== null) {
      ...
      if (gt(y) || at(y)) return (f = f.get(d) || null), h(a, f, y, _, null);
      dr(a, y);
    }
    return null;
  }
  ...
  function S(f, a, d, y) {
    ...
    for (
      var C = (_ = null), N = a, P = (a = 0), H = null, T = d.next();
      N !== null && !T.done;
      P++, T = d.next()
    ) {
      N.index > P ? ((H = N), (N = null)) : (H = N.sibling);
    ...
    if (T.done) return t(f, N), U && gn(f, P), _;
    if (N === null) {
      for (; !T.done; P++, T = d.next())
        (T = m(f, T.value, y)),
          T !== null &&
            ((a = i(T, a, P)), C === null ? (_ = T) : (C.sibling = T), (C = T));
      return U && gn(f, P), _;
    }
      ...
      switch (d.$$typeof) {
        ...
        case Dn:
          e: {
            ...
            (a = Hl(d, f.mode, y)), (a.return = f), (f = a);
          }
          return o(f);
        case Ze:
    ...
    return (typeof d == "string" && d !== "") || typeof d == "number"
      ? ((d = "" + d),
        a !== null && a.tag === 6
          ...
          : (t(f, a), (a = Bl(d, f.mode, y)), (a.return = f), (f = a)),
        o(f))
      : t(f, a);
  }
  return F;
...
function vo(e, n, t, r, l, i) {
  if (
    ...
    i = 0;
    do {
      if (((Nt = !1), (Ht = 0), 25 <= i)) throw Error(g(301));
      (i += 1),
        (Z = Y = null),
        (n.updateQueue = null),
        (_r.current = rd),
...
function ka(e, n, t) {
  return Pn & 21
    ? (De(t, n) || ((t = Cs()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function ed(e, n, t) {
  ...
  if (xa(e)) _a(n, l);
    ...
    (t = ra(e, n, l, r)),
      t !== null && ((l = oe()), Re(t, e, r, l), Ea(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
var Yr = {
  ...
  nd = {
    ...
    useTransition: function () {
      var e = wu(!1),
        n = e[0];
      return (e = qf.bind(null, e[1])), (Me().memoizedState = e), [n, e];
    },
...
function od(e, n, t, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), ce || u)) {
    ...
    return No(), (r = Al(Error(g(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Mi(Le), (Le = null)))),
        Pi(e, n),
        te(n),
        null
      );
    ...
    case 13:
      if (
        ...
        if (U && he !== null && n.mode & 1 && !(n.flags & 128))
          ...
          te(n), (i = !1);
        } else Le !== null && (Mi(Le), (Le = null)), (i = !0);
...
function fd(e, n) {
  ...
  for (di = { focusedElem: e, selectionRange: t }, Or = !1, x = n; x !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[hi], delete n[Yf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Va(e, n, t) {
  for (var r = (e.mode & 1) !== 0; x !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (x = i)) : Ou(e);
  }
}
function Ou(e) {
  for (; x !== null; ) {
...
function Ba(e, n) {
  if (((Nr = -1), (Pr = 0), R & 6)) throw Error(g(327));
  var t = e.callbackNode;
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Kt), _n(e, 0), be(e, r), pe(e, Q()), t);
    if (n === 6) be(e, r);
    else {
      if (
...
function Fu(e) {
  ...
  if (t === 1) throw ((t = Kt), _n(e, 0), be(e, n), pe(e, Q()), t);
...
function jn(e) {
  ...
  try {
    ...
    (D = r), (_e.transition = t), (R = n), !(R & 6) && hn();
  }
}
function Co() {
  (me = Wn.current), I(Wn);
...
function Jr(e, n) {
  ...
  while (!0);
  if ((uo(), (R = t), (Xr.current = r), K !== null)) throw Error(g(261));
  return (J = null), (b = 0), X;
}
function hd() {
  for (; K !== null; ) Qa(K);
...
function wn(e, n, t) {
  var r = D,
    l = _e.transition;
  try {
    (_e.transition = null), (D = 1), yd(e, n, t, r);
  } finally {
    (_e.transition = l), (D = r);
  }
  return null;
...
function Zn() {
  if (nn !== null) {
    var e = Ns(Zr),
      ...
      t = D;
    try {
      if (((_e.transition = null), (D = 16 > e ? 16 : e), nn === null))
        var r = !1;
      else {
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = tt(Error(g(423)), n)), (n = ju(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = tt(Error(g(424)), n)), (n = ju(e, n, r, t, l));
            break e;
          } else
            for (
...
function zr(e, n, t, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) Po(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Ql:
        return (
          (e = xe(12, t, n, l | 2)), (e.elementType = Ql), (e.lanes = i), e
        );
      case Kl:
...
vs = Eo;
ys = jn;
var Pd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, hs, Eo] },
  vt = {
  ...
  zd = {
    ...
    findFiberByHostInstance: vt.findFiberByHostInstance || Cd,
  ...
  return v.jsxs("nav", {
    ...
    children: [
      v.jsxs("div", {
        ...
        children: [
          v.jsx("img", { src: nc, alt: "DotDager" }),
          v.jsx("h1", { children: "dotdager" }),
        ],
      }),
      v.jsxs("ul", {
        ...
        children: [
          v.jsx("li", {
            children: v.jsx("a", { href: "#home", children: "Home" }),
          }),
          v.jsx("li", {
            children: v.jsx("a", { href: "#about", children: "About" }),
          }),
          v.jsx("li", {
            children: v.jsx("a", { href: "#interest", children: "Interests" }),
          }),
          v.jsx("li", {
    ...
    children: [
      v.jsx("header", {
        ...
        children: v.jsxs("div", {
          ...
          children: [
            v.jsx("p", { className: "header__hi", children: "Holi" }),
            v.jsx("a", {
              href: "#home",
              className: "header__arrow",
              children: v.jsx("i", { className: "bx bx-down-arrow " }),
            }),
          ],
        }),
      }),
      v.jsxs("main", {
        children: [
              ...
              v.jsxs("div", {
                ...
                children: [
                  ...
                  v.jsxs("div", {
                    ...
                    children: [
                      v.jsx("span", { className: "home__content-line" }),
                      v.jsx("p", {
                  ...
                  v.jsxs("div", {
                    ...
                    children: [
                      v.jsx("a", {
                        href: "#",
                        children: v.jsx("i", { className: "bx bxl-youtube" }),
                      }),
                      v.jsx("a", {
                        href: "#",
                        children: v.jsx("i", { className: "bx bxl-github" }),
                      }),
                      v.jsx("a", {
                        href: "#",
                        children: v.jsx("i", { className: "bx bxl-instagram" }),
                      }),
                      v.jsx("a", {
                        href: "#",
                        children: v.jsx("i", { className: "bx bxl-reddit" }),
                      }),
                    ],
                  }),
                ],
          ...
          v.jsx("section", { className: "about", id: "about" }),
          v.jsx("section", { className: "interests", id: "intetests" }),
          v.jsxs("section", {
            className: "contact",
            id: "contact",
            children: [
              v.jsxs("div", {
                ...
                children: [
                  ...
                  v.jsxs("div", {
                    ...
                    children: [
                      ...
                      v.jsxs("div", {
                        className: "info__container",
                        children: [
                          v.jsx("i", { className: "bx bxs-phone info__icon" }),
                          v.jsx("p", {
                            className: "info__value",
                  ...
                  v.jsx("span", { className: "contact__line" }),
                  v.jsxs("div", {
        ...
        children: [
          ...
          v.jsxs("div", {
            ...
            children: [
              ...
              v.jsx("span", { className: "footer__line" }),
              v.jsx("p", {
      ...
      v.jsx("section", {
        ...
        children: v.jsxs("div", {
          ...
          children: [
            v.jsx("p", { className: "bye__bye", children: "Chau" }),
            v.jsx("a", {
              href: "#home",
              className: "bye__arrow",
              children: v.jsx("i", { className: "bx bx-up-arrow " }),
            }),
          ],
        }),
      }),
...
ec(document.getElementById("root")).render(
  v.jsx(Ai.StrictMode, { children: v.jsx(Rd, {}) })
);
